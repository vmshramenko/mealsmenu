...
import com.example.mealsmenu.viewmodels.DessertViewModel


class DessertFragment : BaseCategoryFragment() {
    ...
    override fun initViewModel(): BaseViewModel {
        return ViewModelProvider(this)[DessertViewModel::class.java]
    }
}