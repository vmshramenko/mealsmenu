...
import com.example.mealsmenu.viewmodels.VegetarianViewModel

class VegetarianFragment : BaseCategoryFragment() {
    ...
    override fun initViewModel(): BaseViewModel {
        return ViewModelProvider(this)[VegetarianViewModel::class.java]
    }
}