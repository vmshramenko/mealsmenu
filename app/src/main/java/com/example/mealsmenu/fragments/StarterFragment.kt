...
import com.example.mealsmenu.viewmodels.StarterViewModel


class StarterFragment : BaseCategoryFragment() {
    ...
    override fun initViewModel(): BaseViewModel {
        return ViewModelProvider(this)[StarterViewModel::class.java]
    }
}