...
import com.example.mealsmenu.viewmodels.MiscellaneousViewModel


class MiscellaneousFragment : BaseCategoryFragment() {
    ...
    override fun initViewModel(): BaseViewModel {
        return ViewModelProvider(this)[MiscellaneousViewModel::class.java]
    }
}